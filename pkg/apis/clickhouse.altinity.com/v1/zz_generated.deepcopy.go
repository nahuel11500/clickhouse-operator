...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetricsFilters) DeepCopyInto(out *MetricsFilters) {
	*out = *in
	if in.DropMetrics != nil {
		in, out := &in.DropMetrics, &out.DropMetrics
	...
	if in.DropMetricPrefixes != nil {
		in, out := &in.DropMetricPrefixes, &out.DropMetricPrefixes
		*out = new(types.Strings)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
	...
	if in.KeepMetrics != nil {
		in, out := &in.KeepMetrics, &out.KeepMetrics
		*out = new(types.Strings)
		if **in != nil {
			in, out := *in, *out
			*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsFilters.
func (in *MetricsFilters) DeepCopy() *MetricsFilters {
	if in == nil {
		return nil
	}
	out := new(MetricsFilters)
...
func (in *ReconcileHostDropReplicas) DeepCopyInto(out *ReconcileHostDropReplicas) {
	*out = *in
	...
	if in.OnLostVolume != nil {
		in, out := &in.OnLostVolume, &out.OnLostVolume
		*out = new(types.StringBool)
		**out = **in
	}
	if in.Active != nil {
